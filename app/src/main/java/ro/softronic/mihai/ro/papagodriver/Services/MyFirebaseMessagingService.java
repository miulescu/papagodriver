package ro.softronic.mihai.ro.papagodriver.Services;
...
import ro.softronic.mihai.ro.papagodriver.Activities.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getFrom().equals("/topics/" + MyFirebaseInstanceIDService.infoTopicName)) {
            ...
            String orders = remoteMessage.getData().get("order");
            String id1 = "";
            String id2 = "";
            try {
                ...
                for (int i = 0; i < ordersArray.length(); i++) {
                    ...
                    id1 = jsonobject.getString("id1");
                    id2 = jsonobject.getString("id2");
                }
